...
local genScript = toolbar:CreateButton("Generate Sippet", "Type a specific command like 'class' to generate a snippet!", "rbxassetid://6723816509")
local packScript = toolbar:CreateButton("Settings", "Set custom snippets, or configure code", "rbxassetid://6723815758")
...
function main()
	...
	local function createCustomScript()
